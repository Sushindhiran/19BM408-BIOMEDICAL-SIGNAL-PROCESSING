...
dataStruct = load("EEGdata .mat");

vars = fieldnames(dataStruct);
eeg = dataStruct.(vars{1}); 
...
<img width="775" height="608" alt="BSPEXP11FIG1" src="https://github.com/user-attachments/assets/3629b216-0947-4a77-8ea8-7203c691e6d9" />
